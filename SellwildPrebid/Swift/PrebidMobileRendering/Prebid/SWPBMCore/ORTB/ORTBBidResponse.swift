...
class ORTBBidResponse<
    ExtType: SWPBMJsonCodable,
    SeatBidExtType: SWPBMJsonCodable,
    BidExtType: SWPBMJsonCodable
>: SWPBMJsonCodable, ORTBExtensible {
    ...
    /// [Integer]
    /// Reason for not bidding. See `SWPBMORTBNoBidReason`
    var nbr: NSNumber?
