...
@objcMembers
public class SellwildPrebid: NSObject {
    ...
    /// The singleton instance of the `SellwildPrebid` class.
    public static let shared = SellwildPrebid()
    ...
    public func getStoredBidResponses() -> [[String: String]]? {
        ...
        for(bidder, responseId) in SellwildPrebid.shared.storedBidResponses {
