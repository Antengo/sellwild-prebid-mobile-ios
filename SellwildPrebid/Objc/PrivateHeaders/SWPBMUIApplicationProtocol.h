...
@protocol SWPBMUIApplicationProtocol
...
@interface UIApplication (SWPBMUIApplicationProtocol) <SWPBMUIApplicationProtocol>
@end

@implementation UIApplication (SWPBMUIApplicationProtocol)
