...
@class SWPBMORTBPublisher;
@class SWPBMORTBAppExt;
@class SWPBMORTBAppContent;
...
@interface SWPBMORTBApp : SWPBMORTBAbstract
...
@property (nonatomic, strong, nullable) SWPBMORTBPublisher *publisher;

//This object describes the content in which the impression will appear, which may be syndicated or nonsyndicated content.
@property (nonatomic, strong, nullable) SWPBMORTBAppContent *content;
...
@property (nonatomic, strong) SWPBMORTBAppExt *ext;
