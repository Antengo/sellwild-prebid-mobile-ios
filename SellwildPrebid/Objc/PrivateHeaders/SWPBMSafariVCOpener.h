...
#import "SWPBMViewControllerProvider.h"
...
@class SWPBMModalManager;

typedef SWPBMOpenMeasurementSession * _Nullable (^SWPBMOpenMeasurementSessionProvider)(void);

NS_ASSUME_NONNULL_BEGIN

@interface SWPBMSafariVCOpener : NSObject <SFSafariViewControllerDelegate>
...
- (instancetype)initWithSDKConfiguration:(SellwildPrebid *)sdkConfiguration
             ...
             onWillLoadURLInClickthrough:(nullable SWPBMVoidBlock)onWillLoadURLInClickthrough
               ...
               onClickthroughPoppedBlock:(nullable SWPBMModalStatePopHandler)onClickthroughPoppedBlock
                      onDidLeaveAppBlock:(nullable SWPBMModalStateAppLeavingHandler)onDidLeaveAppBlock NS_DESIGNATED_INITIALIZER;
