...
@interface SWPBMVastCreativeCompanionAdsCompanion : NSObject <SWPBMVastResourceContainerProtocol>

@property (nonatomic, assign) NSInteger width;
@property (nonatomic, assign) NSInteger height;
@property (nonatomic, strong, nonnull) SWPBMVastTrackingEvents *trackingEvents;
