...
@interface SWPBMMRAIDJavascriptCommands : NSObject
...
+ (NSString *)onStateChange:(SWPBMMRAIDState *)newState;
+ (NSString *)onAudioVolumeChange:(nullable NSNumber *)volumePercentage;

// update Ad data
+ (NSString *)updateSupportedFeatures;
+ (NSString *)updatePlacementType:(SWPBMMRAIDPlacementType)type;
...
// error
+ (NSString *)onErrorWithMessage:(NSString *)message action:(SWPBMMRAIDAction)action
