...
@class SWPBMRewardedConfig;
@protocol SWPBMTransaction;

@interface SWPBMVideoCreative : SWPBMAbstractCreative_Objc <SWPBMVideoViewDelegate>

@property (class, readonly) NSInteger maxSizeForPreRenderContent;

- (nonnull instancetype)initWithCreativeModel:(nonnull SWPBMCreativeModel *)creativeModel
