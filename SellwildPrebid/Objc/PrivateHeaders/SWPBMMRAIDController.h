...
@protocol SWPBMCreativeViewDelegate;
@class SWPBMModalManager;
@class SWPBMWebView;
@class SWPBMMRAIDCommand;
@class SWPBMOpenMeasurementSession;
@class SWPBMMRAIDState;

@interface SWPBMMRAIDController : NSObject

@property (nonatomic, assign, nonnull) SWPBMMRAIDState *mraidState;
