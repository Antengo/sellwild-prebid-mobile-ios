...
@class SWPBMORTBDeviceExtAtts;
@class SWPBMORTBDeviceExtPrebid;
@class SWPBMORTBGeo;
...
@interface SWPBMORTBDevice : SWPBMORTBAbstract
...
@property (nonatomic, strong) SWPBMORTBGeo *geo;
...
@property (nonatomic, readonly) SWPBMORTBDeviceExtPrebid *extPrebid;
@property (nonatomic, readonly) SWPBMORTBDeviceExtAtts *extAtts;
