...
#import "SWPBMORTBAbstract.h"

@class SWPBMORTBBanner;
@class SWPBMORTBImpExtPrebid;
@class SWPBMORTBImpExtSkadn;
@class SWPBMORTBNative;
@class SWPBMORTBPmp;
@class SWPBMORTBVideo;
...
@interface SWPBMORTBImp : SWPBMORTBAbstract
...
@property (nonatomic, strong, nullable) SWPBMORTBBanner * banner;

//A Video object (Section 3.2.7); required if this impression is offered as a video ad opportunity.
@property (nonatomic, strong, nullable) SWPBMORTBVideo *video;
...
@property (nonatomic, strong, nullable) SWPBMORTBNative * native;

//A Pmp object (Section 3.2.11) containing any private marketplace deals in effect for this impression.
@property (nonatomic, strong) SWPBMORTBPmp * pmp;
...
@property (nonatomic, strong) SWPBMORTBImpExtPrebid *extPrebid;
@property (nonatomic, strong) SWPBMORTBImpExtSkadn  *extSkadn;
