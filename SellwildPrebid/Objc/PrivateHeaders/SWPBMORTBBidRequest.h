...
@class SWPBMORTBApp;
@class SWPBMORTBBidRequestExtPrebid;
@class SWPBMORTBDevice;
@class SWPBMORTBImp;
@class SWPBMORTBRegs;
...
@interface SWPBMORTBBidRequest : SWPBMORTBAbstract
...
@property(nonatomic, copy) NSArray<SWPBMORTBImp *> *imp;
...
@property(nonatomic, readonly) SWPBMORTBSource *source;

// A Regs object (Section 3.2.3) that specifies any industry, legal,
// or governmental regulations in force for this request.
@property(nonatomic, strong) SWPBMORTBRegs *regs;

// Placeholder for exchange-specific extensions to OpenRTB.
// Note: ext object not supported.

@property(nonatomic, strong) SWPBMORTBBidRequestExtPrebid *extPrebid;
