...
typedef void(^SWPBMCreativeFactoryFinishedCallback)(NSArray<id<SWPBMAbstractCreative>> * _Nullable, NSError * _Nullable);
typedef void(^SWPBMCreativeFactoryDownloadDataCompletionClosure)(NSURL* _Nonnull, SWPBMDownloadDataCompletionClosure _Nonnull);
