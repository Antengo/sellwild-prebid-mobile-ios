...
//To represent this, we have this class implemented as abstract and SWPBMVastWrapperAd and SWPBMVastInlineAd are concrete.

@interface SWPBMVastAbstractAd : NSObject

@property (nonatomic, weak, nullable) SWPBMVastResponse *ownerResponse;
...
@property (nonatomic, strong, nonnull) NSMutableArray<SWPBMVastCreativeAbstract *> *creatives;
