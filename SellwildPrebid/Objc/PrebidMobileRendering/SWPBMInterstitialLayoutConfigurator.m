...
@implementation SWPBMInterstitialLayoutConfigurator

+ (void)configurePropertiesWithAdConfiguration:(SWPBMAdConfiguration *)adConfiguration displayProperties:(SWPBMInterstitialDisplayProperties *)displayProperties {
    SWPBMInterstitialLayout layout = adConfiguration.interstitialLayout;
    if (layout && layout != SWPBMInterstitialLayoutUndefined) {
...
+ (SWPBMInterstitialLayout)calculateLayoutFromSize:(CGSize)size {
    return SWPBMInterstitialLayoutAspectRatio;
}
