...
@interface SWPBMDeviceInfoParameterBuilder()

@property (nonatomic, strong) SWPBMDeviceAccessManager *deviceAccessManager;

@end

#pragma mark - Implementation

@implementation SWPBMDeviceInfoParameterBuilder
...
- (nonnull instancetype)initWithDeviceAccessManager:(nonnull SWPBMDeviceAccessManager *)deviceAccessManager {
    self = [super init];
    if (self) {
        SWPBMAssert(deviceAccessManager);
