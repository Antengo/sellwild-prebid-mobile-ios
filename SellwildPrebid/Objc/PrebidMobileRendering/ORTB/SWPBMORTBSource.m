...
#import "SWPBMORTBSourceExtOMID.h"

@implementation SWPBMORTBSource

- (instancetype)init {
    if (!(self = [super init])) {
        return nil;
    }
    _extOMID = [[SWPBMORTBSourceExtOMID alloc] init];
    return self;
}
...
- (nonnull SWPBMJsonDictionary *)toJsonDictionary {
    ...
    SWPBMJsonDictionary * const extOmidDic = [self.extOMID toJsonDictionary];
    if (extOmidDic.count) {
        ret[@"ext"] = extOmidDic;
    }
...
- (instancetype)initWithJsonDictionary:(nonnull SWPBMJsonDictionary *)jsonDictionary {
    ...
    _extOMID = [[SWPBMORTBSourceExtOMID alloc] initWithJsonDictionary:jsonDictionary[@"ext"]];
