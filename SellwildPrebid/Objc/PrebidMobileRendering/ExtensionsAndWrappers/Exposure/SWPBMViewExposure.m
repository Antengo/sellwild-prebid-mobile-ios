...
@interface SWPBMViewExposure_Objc : NSObject <SWPBMViewExposure>
@end

@implementation SWPBMViewExposure_Objc
...
+ (instancetype)zeroExposure {
    ...
    static id <SWPBMViewExposure> zeroViewExposure;
    dispatch_once(&onceToken, ^{
        zeroViewExposure = [SWPBMFactory createViewExposureWithExposureFactor:0 visibleRectangle:CGRectZero occlusionRectangles:nil];
    });
...
- (BOOL)isEqual:(id)object {
    ...
    SWPBMViewExposure_Objc *other = object;
    return ((self == other)
