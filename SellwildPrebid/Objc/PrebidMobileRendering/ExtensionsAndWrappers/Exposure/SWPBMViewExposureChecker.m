...
@interface SWPBMViewExposureChecker()
...
@implementation SWPBMViewExposureChecker

// MARK: - Public API

+ (id<SWPBMViewExposure>)exposureOfView:(UIView *)view {
    return [[[SWPBMViewExposureChecker alloc] initWithView:view] exposure];
}
...
#   endif
    ...
    return [SWPBMFactory createViewExposureWithExposureFactor:(clipArea - obstructedArea)/fullArea
