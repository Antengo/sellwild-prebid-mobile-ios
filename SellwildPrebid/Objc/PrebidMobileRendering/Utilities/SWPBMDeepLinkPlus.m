...
@implementation SWPBMDeepLinkPlus

+ (nullable instancetype)deepLinkPlusWithURL:(NSURL *)url {
    SWPBMDeepLinkPlus * deepLinkPlus = [[SWPBMDeepLinkPlus alloc] init];
...
- (BOOL)parseURL:(NSURL * _Nonnull)url {
    ...
    for (NSURLQueryItem *queryItem in queryItems) {
        ...
        NSURL *valueURL = [NSURL SWPBMURLWithoutEncodingFromString:queryItem.value];
        if (valueURL != nil) {
