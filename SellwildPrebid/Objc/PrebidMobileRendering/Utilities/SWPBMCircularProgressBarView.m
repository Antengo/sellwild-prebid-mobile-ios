...
@interface SWPBMCircularProgressBarView ()
@property NSDate *startTime;
@property NSTimeInterval refreshInterval;  // refresh every n seconds.
@end

@implementation SWPBMCircularProgressBarView  //!OCLINT(too many methods - 35)
...
-(SWPBMCircularProgressBarLayer*)progressLayer{
    SWPBMCircularProgressBarLayer* layer = (SWPBMCircularProgressBarLayer*) self.layer;
    return layer;
}

+ (Class) layerClass {
    return [SWPBMCircularProgressBarLayer class];
}
