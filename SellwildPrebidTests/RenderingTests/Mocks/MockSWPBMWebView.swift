...
class MockSWPBMWebView: SWPBMWebView {
    ...
    var mock_SWPBMAddCropAndCenterConstraints: ((CGFloat, CGFloat) -> Void)?
    override func SWPBMAddCropAndCenterConstraints(initialWidth: CGFloat, initialHeight: CGFloat) {
        self.mock_SWPBMAddCropAndCenterConstraints?(initialWidth, initialHeight)
    }
    
    var mock_MRAID_error: ((String, SWPBMMRAIDAction) -> Void)?
    override func MRAID_error(_ message: String, action: SWPBMMRAIDAction) {
