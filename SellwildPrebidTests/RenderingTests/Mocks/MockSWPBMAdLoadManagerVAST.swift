...
class MockSWPBMAdLoadManagerVAST: SWPBMAdLoadManagerVAST {
    
    var mock_requestCompletedSuccess: ((SWPBMAdRequestResponseVAST) -> Void)?
    override func requestCompletedSuccess(_ adRequestResponse: SWPBMAdRequestResponseVAST) {
