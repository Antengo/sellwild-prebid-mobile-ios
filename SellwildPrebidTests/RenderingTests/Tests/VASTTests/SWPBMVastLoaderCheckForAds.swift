...
class SWPBMVastLoaderCheckForAds : XCTestCase {
    
    let sdkConfiguration = SellwildPrebid.mock
    
    var wrapper1:SWPBMVastWrapperAd! = nil
    var wrapper2:SWPBMVastWrapperAd! = nil
    var inline:SWPBMVastInlineAd! = nil
    
    var response1:SWPBMVastResponse!
    var response2:SWPBMVastResponse!
    var response3:SWPBMVastResponse!
    
    var vastAdsBuilder:SWPBMVastAdsBuilder?
    ...
    override func setUp() {
        ...
        self.vastAdsBuilder = SWPBMVastAdsBuilder(connection: connection)
        
        wrapper1 = SWPBMVastWrapperAd()
        wrapper2 = SWPBMVastWrapperAd()
        inline = SWPBMVastInlineAd()
        
        response1 = SWPBMVastResponse()
        response2 = SWPBMVastResponse()
        response3 = SWPBMVastResponse()
