...
class SWPBMVastLoaderTestOMVerificationOneInline: XCTestCase {
    ...
    func requestCompletedSuccess(_ vastResponse: SWPBMAdRequestResponseVAST) {
        ...
        SWPBMAssertEq(resource1.url, "https://measurement.domain.com/tag.js")
        SWPBMAssertEq(resource1.vendorKey, "OpenX1")
        SWPBMAssertEq(resource1.params, "{1}")
        SWPBMAssertEq(resource1.apiFramework, "omidOpenx1")
        
        let resource2 = ad.verificationParameters.verificationResources[1]
        SWPBMAssertEq(resource2.url, "https://measurement.domain.com/tag2.js")
        SWPBMAssertEq(resource2.vendorKey, "OpenX2")
        SWPBMAssertEq(resource2.params, "{2}")
        SWPBMAssertEq(resource2.apiFramework, "omidOpenx2")
