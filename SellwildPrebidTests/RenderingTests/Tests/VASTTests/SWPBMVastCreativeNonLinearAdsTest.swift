...
class SWPBMVastCreativeNonLinearAdsTest: XCTestCase {
    
    // Verify SWPBMVastCreativeNonLinearAds.copyTracking() copies over the correct number of URIs
    func testCopyTracking() {
        
        let ad1 = SWPBMVastCreativeNonLinearAds()
        ad1.id = "111111"
        
        let nonLinear1 = SWPBMVastCreativeNonLinearAdsNonLinear()
        nonLinear1.clickThroughURI = "URI_1"
        nonLinear1.clickTrackingURIs = ["URI_1a", "URI_1b"]
        ad1.nonLinears.add(nonLinear1)
        
        let ad2 = SWPBMVastCreativeNonLinearAds()
        ad2.id = "222222"
        
        let nonLinear2 = SWPBMVastCreativeNonLinearAdsNonLinear()
        ...
        var nonLinear = ad1.nonLinears[0] as! SWPBMVastCreativeNonLinearAdsNonLinear
        ...
        nonLinear = ad1.nonLinears[0] as! SWPBMVastCreativeNonLinearAdsNonLinear
        XCTAssert(nonLinear.clickTrackingURIs.contains("URI_1a"))
        XCTAssert(nonLinear.clickTrackingURIs.contains("URI_1b"))
