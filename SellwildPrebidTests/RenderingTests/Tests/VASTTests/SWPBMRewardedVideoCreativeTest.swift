...
class SWPBMModalManagerTest: ModalManager {
...
class SWPBMRewardedVideoCreativeTest: XCTestCase, CreativeResolutionDelegate, CreativeViewDelegate {
    ...
    func testCreativeViewDelegateHasCompanionAd() {
        ...
        let videoCreative = SWPBMVideoCreative(creativeModel:model,transaction:UtilitiesForTesting.createEmptyTransaction(),videoData: Data())
    ...
    func testCreativeViewDelegateNoCompanionAd() {
        ...
        let modalManager = SWPBMModalManagerTest()
