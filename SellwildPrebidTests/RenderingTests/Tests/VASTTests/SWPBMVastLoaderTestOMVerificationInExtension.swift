...
class SWPBMVastLoaderTestOMVerificationInExtension: XCTestCase {
    ...
    func requestCompletedSuccess(vastResponse: SWPBMAdRequestResponseVAST) {
        ...
        SWPBMAssertEq(resource1.url, "https://company.com/omid.js")
        SWPBMAssertEq(resource1.vendorKey, "company.com-omid")
        SWPBMAssertEq(resource1.params, "parameter1=value1&parameter2=value2&parameter3=value3")
        SWPBMAssertEq(resource1.apiFramework, "omid")
