...
class VideoCreativeDelegateTest: XCTestCase, CreativeResolutionDelegate, CreativeViewDelegate, SWPBMVideoViewDelegate {
    ...
    func testInit() {
        ...
        self.videoCreative = SWPBMVideoCreative(creativeModel:model, transaction:UtilitiesForTesting.createEmptyTransaction(), videoData: Data())
    ...
    */
    ...
    func testDownloadFailed() {
        ...
        self.videoCreative = SWPBMVideoCreative(creativeModel:CreativeModel(), transaction:UtilitiesForTesting.createEmptyTransaction(), videoData: Data())
        ...
        //Create SWPBMVideoCreative and start
        self.videoCreative = SWPBMVideoCreative(creativeModel:model, transaction:UtilitiesForTesting.createEmptyTransaction(), videoData: Data())
        self.videoCreative.creativeResolutionDelegate = self
        self.videoCreative.creativeViewDelegate = self
        
        let state = Factory.createModalState(view: SWPBMVideoView(),
    ...
    func testSkipOffset() {
        ...
        mockModalManager.mock_pushModalClosure = { (modalState, _, _, _, completionHandler) in
            expectation.fulfill()
            SWPBMAssertEq(model.skipOffset, modalState.displayProperties?.closeDelay as NSNumber?)
            completionHandler?()
        }
    ...
    func testMeassurementSession() {
        ...
        let mockCreativeModel = MockSWPBMCreativeModel(adConfiguration: AdConfiguration())
        ...
        self.videoCreative = SWPBMVideoCreative(
    ...
    func testVideoPlaybackEvents() {
        ...
        let model = CreativeModel(adConfiguration: AdConfiguration())
        self.videoCreative = SWPBMVideoCreative(creativeModel: model,
                                              transaction: UtilitiesForTesting.createEmptyTransaction(),
                                              videoData: Data())
