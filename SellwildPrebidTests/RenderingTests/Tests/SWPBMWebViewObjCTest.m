...
@interface SWPBMWebView (Testable)

- (void)evaluateJavaScript:(NSString *)jsCommand;

@end

@interface SWPBMWebViewObjCTest : XCTestCase<WKNavigationDelegate>

@property (nonnull, strong) XCTestExpectation* expectationNoNavigation;

@end

@implementation SWPBMWebViewObjCTest

- (void)testLoadHTMLNil {
    SWPBMWebView *webView = [SWPBMWebView new];
...
/*
 ...
 NSString *url = nil;
 XCTAssertFalse([SWPBMWebView isMRAIDLink:url]);
 }
 */
