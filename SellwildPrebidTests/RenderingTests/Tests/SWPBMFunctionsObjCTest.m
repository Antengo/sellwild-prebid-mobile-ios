...
//FIXME: impport SWPBMFunctions+Private.h causes the redifinition error for SWPBMLocationSourceValues,...
//Update this test after migration to Swift
//#import "SWPBMFunctions+Private.h"

@interface SWPBMFunctionsObjCTest : XCTestCase

@end

@implementation SWPBMFunctionsObjCTest
...
- (void)testDictionaryFromDataWithNilData {
    /*
     ...
     SWPBMJsonDictionary *dict = [SWPBMFunctions dictionaryFromData:data error:&error];
...
- (void)testDictionaryFromJSONStringWithNilString {
    /*
     ...
     SWPBMJsonDictionary *dict = [SWPBMFunctions dictionaryFromJSONString:jsonString error:&error];
...
- (void)testToStringJsonDictionaryWithNilJSON {
    /*
     SWPBMJsonDictionary *jsonDict = nil;
     NSError *error = nil;
     NSString *jsonString = [SWPBMFunctions toStringJsonDictionary:jsonDict error:&error];
