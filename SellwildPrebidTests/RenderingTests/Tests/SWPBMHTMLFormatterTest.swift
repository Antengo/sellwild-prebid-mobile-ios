...
class SWPBMHTMLFormatterTest: XCTestCase {
    ...
    func testhtmlWithBodyAndHTMLTags() {
        ...
        actual = SWPBMHTMLFormatter.ensureHTMLHasBodyAndHTMLTags(htmlMissingHTMLTags)
        XCTAssert(expected == actual, "Expected ensureHTMLHasBodyAndHTMLTags to add html tags = \(expected), actual = \(actual)")
        
        actual = SWPBMHTMLFormatter.ensureHTMLHasBodyAndHTMLTags(baseCreative)
        ...
        actual = SWPBMHTMLFormatter.ensureHTMLHasBodyAndHTMLTags(properlyFormedHTML)
        ...
        actual = SWPBMHTMLFormatter.ensureHTMLHasBodyAndHTMLTags(htmlMissingHTMLOpeningTag)
        XCTAssert(expected == actual, "Expected ensureHTMLHasBodyAndHTMLTags to add missing tag. Expected = \(expected), actual = \(actual)")
        
        actual = SWPBMHTMLFormatter.ensureHTMLHasBodyAndHTMLTags(htmlMissingHTMLClosingTag)
        XCTAssert(expected == actual, "Expected ensureHTMLHasBodyAndHTMLTags to add missing tag. Expected = \(expected), actual = \(actual)")
    }
    ...
    func testJSScriptFormatting() {
        ...
        var actual = SWPBMHTMLFormatter.ensureHTMLHasBodyAndHTMLTags(htmlWithScript)
        XCTAssert(expected == actual, "Expected ensureHTMLHasBodyAndHTMLTags to add missing tag. Expected = \(expected), actual = \(actual)")
        ...
        actual = SWPBMHTMLFormatter.ensureHTMLHasBodyAndHTMLTags(htmlWithScript)
        XCTAssert(expected == actual, "Expected ensureHTMLHasBodyAndHTMLTags to add missing tag. Expected = \(expected), actual = \(actual)")
    }
    ...
    func testWithWrongStyleTagFormatting() {
        ...
        let actual = SWPBMHTMLFormatter.ensureHTMLHasBodyAndHTMLTags(htmlStileOpeningTag)
