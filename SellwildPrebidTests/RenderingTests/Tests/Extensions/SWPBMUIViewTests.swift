...
class SWPBMUIViewTests: XCTestCase {
    ...
    func testAddConstraintWithoutSuperview() {
        ...
        testView.SWPBMAddBottomRightConstraints(viewSize: viewSize, marginSize: marginSize)
        testView.SWPBMAddTopRightConstraints(viewSize: viewSize, marginSize: marginSize)
        testView.SWPBMAddTopLeftConstraints(viewSize: viewSize, marginSize: marginSize)
        
        testView.SWPBMAddCropAndCenterConstraints(initialWidth: testWidth, initialHeight: testHeight)
    ...
    func testSWPBMAddFillSuperviewConstraints() {
    ...
    func testSWPBMAddConstraintsFromCGRect() {
        // Prepare
    ...
    func testSWPBMAddCropAndCenterConstraints() {
    ...
    func testSWPBMAddBottomRightConstraints() {
    ...
    func testSWPBMAddTopRightConstraints() {
    ...
    func testSWPBMAddTopLeftConstraints() {
