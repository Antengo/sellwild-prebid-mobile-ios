...
class SWPBMVastCreativeCompanionAdsTest: XCTestCase {
    ...
    func testRequiredMode() {
        ...
        creative.requiredMode = SWPBMVastRequiredMode.all.rawValue
        XCTAssert(creative.canPlayRequiredCompanions())
        
        creative.requiredMode = SWPBMVastRequiredMode.any.rawValue
        XCTAssert(creative.canPlayRequiredCompanions())
    }
}
