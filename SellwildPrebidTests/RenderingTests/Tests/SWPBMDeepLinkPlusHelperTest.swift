...
class SWPBMDeepLinkPlusHelperTest: XCTestCase {
    func testDeepLinkDetection() {
        let isDeepLinkPlus: (String)->Bool = { urlString in
            let url: URL! = URL(string: urlString)
            XCTAssertNotNil(url)
            return SWPBMDeepLinkPlusHelper.isDeepLinkPlusURL(url)
        }
    ...
    func testDemoLinkHandlingPrimary() {
        ...
        SWPBMDeepLinkPlusHelper.application = mockApplication
        SWPBMDeepLinkPlusHelper.connection = mockConnection
        
        let deepLinkResolved = expectation(description: "deepLinkResolved")
        
        SWPBMDeepLinkPlusHelper.tryHandleDeepLinkPlus(demoURL) { (visited, fallbackURL, fallbackTrackingURLs) in
    ...
    func testVisitingTrackingLinks() {
        ...
        SWPBMDeepLinkPlusHelper.visitTrackingURLs(links)
