...
class SWPBMHTMLCreativeTest_Base: XCTestCase, CreativeViewDelegate {
    
    let timeout: TimeInterval = 1
    var htmlCreative: MockSWPBMHTMLCreative!
    ...
    override func setUp() {
        ...
        mockCreativeModel = MockSWPBMCreativeModel(adConfiguration: AdConfiguration())
        mockCreativeModel.width = 320
        mockCreativeModel.height = 50
        mockCreativeModel.html = "test"
        
        mockEventTracker = MockSWPBMAdModelEventTracker(creativeModel: mockCreativeModel, serverConnection: serverConnection)
        mockCreativeModel.eventTracker = mockEventTracker
        
        //Set up HTML Creative
        mockModalManager = MockModalManager()
        mockWebView = MockSWPBMWebView()
        htmlCreative = MockSWPBMHTMLCreative(
