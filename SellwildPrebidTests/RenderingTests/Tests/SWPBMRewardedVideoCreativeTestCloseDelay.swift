...
class SWPBMRewardedVideoCreativeTestCloseDelay : XCTestCase {
    ...
    private func calculateCloseDelay(with model: CreativeModel, pubCloseDelay:TimeInterval) -> TimeInterval {
        ...
        let creative = SWPBMVideoCreative(creativeModel: model, transaction:UtilitiesForTesting.createEmptyTransaction(), videoData:Data())
