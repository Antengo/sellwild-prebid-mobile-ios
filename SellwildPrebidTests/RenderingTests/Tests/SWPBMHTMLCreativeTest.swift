...
class SWPBMHTMLCreativeTest_PublicAPI: SWPBMHTMLCreativeTest_Base {
    ...
    func testSetupView_failsWithNoHTML() {
        ...
        self.htmlCreative = MockSWPBMHTMLCreative(
        ...
        SWPBMAssertEq(self.htmlCreative.view, nil)
    }
    ...
    func testSetupView_sizesWebViewCorrectly() {
        ...
        SWPBMAssertEq(self.htmlCreative.view?.frame, expectedFrame)
    }
    ...
    func testSetupView_sanitizesHTML() {
        ...
        SWPBMAssertEq(actualHTML, expectedHTML)
    }
    ...
    func testDisplay_triggersImpression() {
        ...
        self.mockEventTracker.mock_trackEvent = { (event) in
            ...
            SWPBMAssertEq(nextEvent == nil, false)
            if (nextEvent != nil) {
                SWPBMAssertEq(event, nextEvent)
    ...
    func testMeassurementSession() {
        ...
        let swpbmCreativeModel = CreativeModel(adConfiguration: AdConfiguration())
        swpbmCreativeModel.displayDurationInSeconds = 30
        swpbmCreativeModel.html = "<html>test html</html>"
...
class SWPBMHTMLCreativeTest : XCTestCase, CreativeResolutionDelegate, CreativeViewDelegate {
    ...
    override func setUp() {
        ...
        self.htmlCreative = MockSWPBMHTMLCreative(creativeModel:swpbmCreativeModel, transaction:UtilitiesForTesting.createEmptyTransaction())
    ...
    override func tearDown() {
        ...
        self.htmlCreative = nil
        logToFile = nil
        SWPBMFunctions.application = nil
        super.tearDown()
    }
    ...
    func testWebViewLoad() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 2.0, execute:{
            ...
            XCTAssertTrue(log.contains("SWPBMWebView is ready to display"))
    ...
    func testWebViewFailLoad() {
        ...
        let webView = self.htmlCreative.view as! SWPBMWebView
        self.htmlCreative.webView(webView, failedToLoadWithError:SWPBMError.error(message: "Failed to load html", type: .internalError))
    ...
    func testClickthroughOpening(useExternalBrowser: Bool) {
        ...
        htmlCreative = MockSWPBMHTMLCreative(
            creativeModel: swpbmCreativeModel,
            transaction:UtilitiesForTesting.createEmptyTransaction(),
            webView: mockWebView,
            sdkConfiguration: sdkConfiguration
        )
        SWPBMFunctions.application = mockApplication
