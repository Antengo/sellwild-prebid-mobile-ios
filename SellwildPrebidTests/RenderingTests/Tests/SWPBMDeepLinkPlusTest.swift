...
class SWPBMDeepLinkPlusTest: XCTestCase {
    func testDemoLinkParsing() {
        ...
        guard let demoURL = URL(string: demoURLString), let deepLink = SWPBMDeepLinkPlus(url: demoURL) else {
    ...
    func testAppSettingsLinkParsing() {
        ...
        guard let settingsURL = URL(string: settingsURLString), let deepLink = SWPBMDeepLinkPlus(url: settingsURL) else {
    ...
    func testBrokenPrimaryLinkParsing() {
        ...
        let deepLink = SWPBMDeepLinkPlus(url: url)
