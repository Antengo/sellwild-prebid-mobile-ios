...
class SWPBMTouchDownRecognizerTests : XCTestCase {
    ...
    func testBasic() {
        ...
        let recognizer = TestableSWPBMTouchDownRecognizer()
        SWPBMAssertEq(recognizer.state, .possible)
        
        // Trigger touch down logic
        recognizer.handleTouch()
        
        // Should transition to Ended
        SWPBMAssertEq(recognizer.state.rawValue, UIGestureRecognizer.State.ended.rawValue)
    }
    ...
    func testDoesNotTransitionIfNotPossible() {
        ...
        SWPBMAssertEq(recognizer.state, .failed)
    }
    ...
    func testTransitionsOnlyOnce() {
        ...
        recognizer.handleTouch()
        SWPBMAssertEq(recognizer.state, .ended)
    ...
    private class TestableSWPBMTouchDownRecognizer: SWPBMTouchDownRecognizer {
