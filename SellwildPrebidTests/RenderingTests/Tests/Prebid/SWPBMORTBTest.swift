...
class SWPBMORTBTest: XCTestCase {
    ...
    private func codeAndDecode<T : SWPBMJsonCodable>(abstract:T, expectedString:String, file: StaticString = #file, line: UInt = #line, decoder: (JsonDictionary) -> T?) {
    ...
    private func codeAndDecode<T : SWPBMJsonCodable>(abstract:T, expectedString:String, file: StaticString = #file, line: UInt = #line) {
        cloneAndCompare(abstract: abstract, expectedString: expectedString, file:file, line: line) { src in
            return T.init(jsonDictionary: src.jsonDictionary)!
        }
    }
    
    private func cloneAndCompare<T : SWPBMJsonCodable>(abstract:T, expectedString:String, file: StaticString = #file, line: UInt = #line, cloneMethod: (T) throws -> T) {
...
extension SWPBMORTBAbstract: SWPBMJsonCodable {
