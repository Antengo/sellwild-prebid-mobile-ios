...
class SWPBMBaseInterstitialAdUnit_DelegationTest: XCTestCase {
    ...
    func testAccountErrorPropagationByInterstitial() {
        ...
        delegate.onCall = { selector, args in
            ...
            XCTAssertEqual(args[1] as? NSError, SWPBMError.prebidInvalidAccountId() as NSError?)
            exp.fulfill()
        }
                                        ...
                                        file: StaticString = #file, line: UInt = #line)
    {
        ...
        func testCall(_ expectedSelector: String, args expectedArgs: [Any], block: () throws -> ()) {
            SWPBMBaseInterstitialAdUnit_DelegationTest.callDelegateMethod(proxyDelegate: proxyDelegate,
    ...
    private func callRewardedAdDelegateMethods(adUnit: RewardedAdUnit,
        ...
        func testCall(_ expectedSelector: String, args expectedArgs: [Any], block: () throws -> ()) {
            SWPBMBaseInterstitialAdUnit_DelegationTest
                .callDelegateMethod(
                    proxyDelegate: proxyDelegate,
                    expectedSelector: expectedSelector,
                    expectedArgs: expectedArgs,
