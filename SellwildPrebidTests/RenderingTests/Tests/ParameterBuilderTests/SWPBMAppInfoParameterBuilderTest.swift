...
class SWPBMAppInfoParameterBuilderTest: XCTestCase {
    
    let parameterDict = ["foo": "bar"]
    let publisherName = "publisherName"
    var bidRequest: SWPBMORTBBidRequest!
    var mockBundle: MockBundle!
    var builder: SWPBMAppInfoParameterBuilder!
    var targeting: Targeting!
    
    override func setUp() {
        super.setUp()
        bidRequest = SWPBMORTBBidRequest()
        mockBundle = MockBundle()
        targeting = Targeting.shared
        targeting.publisherName = publisherName
        
        builder = SWPBMAppInfoParameterBuilder(bundle: mockBundle, targeting: targeting)
    }
    ...
    func testMissingBundleDisplayName() {
        ...
        SWPBMAssertEq(bidRequest.app.name, mockBundle.mockBundleName)
    }
