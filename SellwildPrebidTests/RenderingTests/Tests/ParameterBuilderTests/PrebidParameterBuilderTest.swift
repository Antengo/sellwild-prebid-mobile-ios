...
class PrebidParameterBuilderTest: XCTestCase {
    ...
    private let sdkConfiguration = SellwildPrebid.mock
    ...
    func testStoredBidResponses() {
        SellwildPrebid.shared.addStoredBidResponse(bidder: "testBidder", responseId: "testResponseId")
    ...
    func testAuctionSettingsId() {
        ...
        XCTAssertNotNil(SellwildPrebid.shared.auctionSettingsId)
        XCTAssertEqual(requestWithSettingsId.extPrebid.storedRequestID, auctionSettingsId)
        
        Prebid.reset()
        
        SellwildPrebid.shared.prebidServerAccountId = Prebid.devintAccountID
        let requestWithoutSettingsId = buildBidRequest(with: adUnitConfig)
        XCTAssertNil(SellwildPrebid.shared.auctionSettingsId)
        ...
        XCTAssertNotNil(SellwildPrebid.shared.auctionSettingsId)
        XCTAssertNotNil(SellwildPrebid.shared.prebidServerAccountId)
    ...
    func testIncludewinnersAndIncludeBidderKeysAreNotNil() {
        //Default value
        SellwildPrebid.shared.includeWinners = true
        SellwildPrebid.shared.includeBidderKeys = true
