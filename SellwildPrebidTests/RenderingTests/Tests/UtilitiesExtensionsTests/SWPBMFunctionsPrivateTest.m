...
@interface SWPBMFunctionsPrivateTest : XCTestCase

@end

@implementation SWPBMFunctionsPrivateTest
...
- (void)test_dispatchTimeAfterTimeInterval {
    ...
    dispatch_time_t dispatchTime = [SWPBMFunctions dispatchTimeAfterTimeInterval:expectedWaitTime];
...
- (void)test_dispatchTimeAfterTimeInterval_startTime {
    ...
    NSDate *startTime = [NSDate date];
    dispatch_time_t dispatchTime = [SWPBMFunctions dispatchTimeAfterTimeInterval:expectedWaitTime startTime:DISPATCH_TIME_NOW];
