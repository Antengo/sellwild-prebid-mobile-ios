...
@property (nonatomic, strong, nullable, readwrite) SWPBMAdConfiguration *adConfiguration;
@property (nonatomic, strong, nullable, readwrite) SellwildPrebid *sdkConfiguration;
