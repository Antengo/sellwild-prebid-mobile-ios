...
@interface SWPBMVideoView ()

@property (nonatomic, weak, nullable) SWPBMVideoCreative *creative;
@property (nonatomic, strong) SWPBMAdViewButtonDecorator * _Nonnull skipButtonDecorator;
