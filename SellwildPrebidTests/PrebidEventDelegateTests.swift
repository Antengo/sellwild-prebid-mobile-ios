...
class PrebidEventDelegateTests: XCTestCase {
    ...
    func test_eventDelegate_isCalled() {
        ...
        SellwildPrebid.shared.eventDelegate = delegate
        
        SellwildPrebid.shared.callEventDelegateAsync_prebidBidRequestDidFinishWith(requestData: mockRequestData, responseData: mockResponseData)
